 ...
 * 
 */
public class StandardClassifier implements Runnable, Classifier {
	 ...
	 * @param classify
	 */
	public StandardClassifier(Corpus train, Corpus classify) {
	...
	public StandardClassifier(CueClassifier cueClassif, ScopeClassifier scopeClassif) {
		this.cueClassif = cueClassif;
		this.scopeClassif = scopeClassif;
	}

	public StandardClassifier(String cue) {
	...
	public StandardClassifier(String cue, String scope) {
		this(cue);
	...
	public StandardClassifier(String cue, String scope, String stackParams) {
		this(cue);
